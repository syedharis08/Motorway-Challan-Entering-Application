...
public class VehicleTypeStatsController implements Initializable 
{
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        try 
        {
           String query ="select vehicleType, count(code) as code\n" +
                         "from chalan\n" +
            ...
            {
                series.getData().add(new XYChart.Data<>(p.getResultSet().getString("vehicleType"),p.getResultSet().getInt("code")));
            }
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("vehicleStats.fxml"));
